...
We'll revisit this task of recursively printing out all of the files and folders in your computer as a practice exercise later this week. For now, let's learn the basics of how we can use recursion as a programming technique.
